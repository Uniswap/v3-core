...
import './interfaces/IUniswapV3ERC20.sol';
import './libraries/SafeMath.sol';

contract UniswapV3ERC20 is IUniswapV3ERC20 {
    ...
    function permit(address owner, address spender, uint value, uint deadline, uint8 v, bytes32 r, bytes32 s) override external override {
        ...
        require(recoveredAddress != address(0) && recoveredAddress == owner, 'UniswapV3: INVALID_SIGNATURE');
