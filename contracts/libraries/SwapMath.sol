        ...
        unchecked {
            ...
            if (exactIn) {
                ...
                if (amountRemainingLessFee >= amountIn) sqrtQX96 = sqrtPTargetX96;
                    ...
                    sqrtQX96 = SqrtPriceMath.getNextPriceFromInput(
                        sqrtPX96,
                        liquidity,
            ...
            if (zeroForOne) {
                amountIn = max && exactIn
                    ? amountIn
                    : SqrtPriceMath.getAmount0Delta(sqrtPX96, sqrtQX96, liquidity, true);
                ...
                amountIn = max && exactIn
                    ? amountIn
                    : SqrtPriceMath.getAmount1Delta(sqrtPX96, sqrtQX96, liquidity, true);
                amountOut = max && !exactIn
                    ? amountOut
