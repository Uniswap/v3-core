...
library TickMath {
    ...
    int32 public constant MIN_TICK = -7351;
    int32 public constant MAX_TICK = -MIN_TICK;

    function getRatioAtTick(int32 tick) internal pure returns (FixedPoint128.uq128x128 memory) {
