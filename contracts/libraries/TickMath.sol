...
library TickMath {
    ...
    /// @notice Calculate sqrt(1.0001^tick) * 2^96.  Throw in case |tick| > max tick
    ...
    /// Throw in case sqrtPriceX96 < MIN_SQRT_RATIO, as MIN_SQRT_RATIO is the lowest value getRatioAtTick may
    /// ever return.
