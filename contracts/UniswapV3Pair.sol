...
contract UniswapV3Pair is IUniswapV3Pair {
    ...
    int32 public override tickCurrent; // first tick at or below priceCurrent
    ...
    mapping(int32 => TickInfo) public tickInfos;
    ...
    function _getFeeGrowthBelow(int32 tick, TickInfo storage tickInfo)
        private
        view
    ...
    function _getFeeGrowthAbove(int32 tick, TickInfo storage tickInfo)
        private
        view
    ...
    function _updateTick(int32 tick, int128 liquidityDelta) private returns (TickInfo storage tickInfo) {
    ...
    function _clearTick(int32 tick) private {
        delete tickInfos[tick];
        tickBitMap.flipTick(tick);
    }

    function initialize(int32 tick) external override lock {
