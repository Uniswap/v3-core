...
interface IUniswapV3PairDeployer {
    ...
    /// @return token0 The first token of the pair by address sort order
    /// @return token1 The second token of the pair by address sort order
    /// @return fee The fee collected upon every swap in the pair, denominated in pips
