...
interface IUniswapV3PoolState {
    ...
    /// Returns token0Owed the computed amount of token0 owed to the position as of the last mint/burn/poke,
    /// Returns token1Owed the computed amount of token1 owed to the position as of the last mint/burn/poke
