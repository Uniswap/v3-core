...
contract PriceMathTest {
    ...
    function getInputToRatio(
        ...
        uint256 reserve1,
        uint128 priceRoot,
        uint128 priceTargetRoot,
        uint128 liquidity,
        uint24 lpFee,
        bool zeroForOne
    ) external pure returns (uint256 amountIn, uint256 amountOut) {
        return PriceMath.getInputToRatio(reserve0, reserve1, priceRoot, priceTargetRoot, liquidity, lpFee, zeroForOne);
    }
    ...
    function getGasCostOfGetInputToRatio(
        ...
        PriceMath.getInputToRatio(reserve0, reserve1, priceRoot, priceTargetRoot, liquidity, lpFee, zeroForOne);
