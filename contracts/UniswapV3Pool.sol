...
import './libraries/StateMath.sol';
...
contract UniswapV3Pool is IUniswapV3Pool, NoDelegateCall {
    ...
    using StateMath for StateMath.Slot0;
    ...
    StateMath.Slot0 public override slot0;
        ...
        )
    {
        ...
        StateMath.Slot0 memory _slot0 = slot0; // SLOAD for gas optimization
    ...
    function _updatePosition(
        ...
        Tick.FeeParams memory params = makeFeeParams();
    ...
    function swap(
        ...
        StateMath.Slot0 memory slot0Start = slot0;
        ...
        StateMath.SwapCache memory cache =
            StateMath.SwapCache({
    ...
    function flash(
        ...
        require(balance0Before.add(fee0) <= balance0After && balance1Before.add(fee1) <= balance1After, 'F');
