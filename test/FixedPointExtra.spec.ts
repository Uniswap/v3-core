...
describe('FixedPointExtra', () => {
  ...
  describe('#muluq', () => {
    ...
    it('gas', async () => {
      expect(await fixedPointExtra.muluqGasUsed([Q112.mul(35).div(10)], [Q112.mul(22).div(10)])).to.eq('698')
    })
  })
  ...
  describe('#divuq', () => {
    ...
    it('gas', async () => {
      expect(await fixedPointExtra.divuqGasUsed([Q112.mul(35).div(10)], [Q112.mul(22).div(10)])).to.eq('1114')
    })
  })
})
