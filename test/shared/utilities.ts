...
export function createPairFunctions({
  ...
  async function swap(
    ...
    const priceLimit =
      typeof sqrtPriceLimitX96 === 'undefined'
        ? inputToken === token0
          ? await pair.minSqrtPriceX96()
          : await pair.maxSqrtPriceX96()
        : sqrtPriceLimitX96
    ...
    return method(pair.address, exactInput ? amountIn : amountOut, toAddress, priceLimit)
  }
