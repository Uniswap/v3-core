  ...
  describe('invariants', () => {
    ...
    it('tickLo < tick < tickHi', async () => {
      const testCases = [
        {
          liquidity: 100,
          sqrtPrice: '25054144837504793118641380156',
          ticklo: -887160,
          tickhi: 887160,
          amount0: 317,
          amount1: 32,
        ...
        {
          liquidity: '1797114049888068422011940',
          sqrtPrice: '71640570057197317802937974',
          ticklo: -2470,
          tickhi: 2810,
        },
        {
          liquidity: '179711404988806842201194033052598134',
          sqrtPrice: '71640570057197317802937974',
          ticklo: -2470,
          tickhi: 2810,
        },
        {
          liquidity: '320917197683995560309319026386',
          sqrtPrice: '1205315890798944879562895',
          ticklo: 0,
          tickhi: 284994,
        },
